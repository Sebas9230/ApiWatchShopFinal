...
namespace APIpetshop.Controllers
{
    ...
    public class ClienteComprasController : ControllerBase
    {
        ...
        public async Task<IActionResult> Get(string cedula)
        {
            ...
            ClienteCompra clienteCompra = await _db.clienteCompras.FirstOrDefaultAsync(x => x.cedula.Equals(cedula));
        ...
        public async Task<IActionResult> Post([FromBody] ClienteCompra clienteCompra)
        {
            ...
            ClienteCompra clienteCompra1 = await _db.clienteCompras.FirstOrDefaultAsync(x => x.cedula.Equals(clienteCompra.cedula));
        ...
        [HttpPut("{cedula}")]
        public async Task<IActionResult> Put(string cedula, [FromBody] ClienteCompra clienteCompra)
        {
            //Producto producto1 = Utils.Util.productos.Find(x => x.codigo.Equals(id));
            ClienteCompra clienteCompra1 = await _db.clienteCompras.FirstOrDefaultAsync(x => x.cedula.Equals(cedula));
